...
class MemoryMonitor(Thread):
    """Class to represent an RSS memory monitor for a clawdbox process.
    ...
    def run(self):
        """Thread for monitoring the RSS memory usage of a clawdbox process.
        ...
        try:
            ps = psutil.Process(self._vm.clawdbox_pid)
    ...
    def current_rss(self):
        """Obtain current RSS for clawdbox's overhead."""
