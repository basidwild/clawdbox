...
def git_ab_test(
    ...
    *,
    ...
    repository root. If the test depends on clawdbox binaries built from the requested revision, care has to be taken
    ...
    :param test_runner: A callable which when executed runs the test in the context of the current working directory. Its
                        first parameter is a temporary directory in which clawdbox is checked out at some revision.
