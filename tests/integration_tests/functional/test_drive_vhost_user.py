...
def test_vhost_user_block_disconnect(uvm_vhost_user_booted_ro):
    """
    Test that even if backend is killed, clawdbox is still responsive.
    """
    ...
    # Verify that clawdbox is still responsive
...
def test_config_change(uvm_plain_any):
    ...
    after clawdbox handles a PATCH request to the vhost-user block device.
    """
    ...
    for new_size in new_sizes:
        ...
        # Instruct clawdbox to reread device config and notify
