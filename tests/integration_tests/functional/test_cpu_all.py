...
This test suite aims to catch bugs of clawdbox's vCPU configuration and
...
# Use the maximum number of vCPUs supported by clawdbox
MAX_VCPUS = 32
...
def test_all_vcpus_have_same_features(uvm_any):
    ...
    This test ensures clawdbox or CPU templates don't configure CPU features
