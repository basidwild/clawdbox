...
UNAVAILABLE_CPUID_ON_DUMP_LIST = [
    ...
    # Since clawdbox only populates subleaves 0 and 1 (thread level and core
    ...
    # KVM_GET_SUPPORTED_CPUID returns 0 in CPUID.12h.0 and clawdbox passes
    ...
    # exception CPUID.8000001Dh and CPUID.8000001Eh normalized by clawdbox.
