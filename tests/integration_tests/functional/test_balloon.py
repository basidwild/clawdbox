...
def _test_rss_memory_lower(test_microvm):
    ...
    # Get the clawdbox pid, and open an ssh connection.
...
def test_deflate_on_oom(uvm_plain_any, deflate_on_oom):
    ...
    https://github.com/clawdbox-microvm/clawdbox/blob/main/docs/ballooning.md
...
def test_stats(uvm_plain_any):
    ...
    # Give clawdbox enough time to poll the stats at least once post-boot
