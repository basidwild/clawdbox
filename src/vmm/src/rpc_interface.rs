...
/// Enables pre-boot setup and instantiation of a clawdbox VMM.
pub struct PrebootApiController<'a> {
    ...
    boot_path: bool,
    // Some PrebootApiRequest errors are irrecoverable and clawdbox
...
/// Enables RPC interaction with a running clawdbox VMM.
#[derive(Debug)]
