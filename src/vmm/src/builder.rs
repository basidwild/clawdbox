...
//! Enables pre-boot setup, instantiation and booting of a clawdbox VMM.
...
/// Builds and starts a microVM based on the current clawdbox VmResources configuration.
///
...
/// Builds and boots a microVM based on the current clawdbox VmResources configuration.
///
