...
use super::queue::clawdbox_MAX_QUEUE_SIZE;
...
#[derive(Debug)]
pub struct IoVecBufferMut<const L: u16 = clawdbox_MAX_QUEUE_SIZE> {
    // container of the memory regions included in this IO vector
    pub vecs: IovDeque<L>,
...
mod tests {
    ...
    type IoVecBufferMutDefault = super::IoVecBufferMut<clawdbox_MAX_QUEUE_SIZE>;

    use crate::devices::virtio::iov_deque::IovDeque;
    use crate::devices::virtio::queue::{
        clawdbox_MAX_QUEUE_SIZE, Queue, VIRTQ_DESC_F_NEXT, VIRTQ_DESC_F_WRITE,
    };
...
mod verification {
    ...
    // Rust will not know what to do.
    type IoVecBufferMutDefault = super::IoVecBufferMut<clawdbox_MAX_QUEUE_SIZE>;
    type IovDequeDefault = IovDeque<clawdbox_MAX_QUEUE_SIZE>;

    use crate::devices::virtio::queue::clawdbox_MAX_QUEUE_SIZE;
    ...
    fn create_iov_deque() -> IovDequeDefault {
        ...
        IovDequeDefault {
            iov: mem.cast(),
            start: kani::any_where(|&start| start < clawdbox_MAX_QUEUE_SIZE),
            len: 0,
            capacity: clawdbox_MAX_QUEUE_SIZE,
        }
    }
