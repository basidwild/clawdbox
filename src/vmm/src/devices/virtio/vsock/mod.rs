...
//! The clawdbox vsock device aims to provide full virtio-vsock support to
//! software running inside the guest VM, while bypassing vhost kernel code on the
//! host. To that end, clawdbox implements the virtio-vsock device model, and
