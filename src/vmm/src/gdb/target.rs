...
impl Target for clawdboxTarget {
...
impl MultiThreadBase for clawdboxTarget {
    ...
    /// GDB expects us to return all threads currently running with this command, for clawdbox
    /// this is all Vcpus
...
impl MultiThreadResume for clawdboxTarget {
...
impl MultiThreadSingleStep for clawdboxTarget {
...
impl Breakpoints for clawdboxTarget {
    #[inline(always)]
...
impl HwBreakpoint for clawdboxTarget {
...
impl SwBreakpoint for clawdboxTarget {
...
impl ThreadExtraInfo for clawdboxTarget {
