...
impl Vm {
    ...
    pub fn create_common(kvm: &crate::vstate::kvm::Kvm) -> Result<VmCommon, VmError> {
        ...
        //
        // Similarly, we do retries up to 5 times. Although clawdbox clients are also able to
        // retry, they have to start clawdbox from scratch. Doing retries in clawdbox makes
