...
//! format for clawdbox state snapshots.
//!
...
/// clawdbox snapshot type
///
/// A type used to store and load clawdbox snapshots of a particular version
