...
const MSR_EXCLUSION_LIST: [MsrRange; 10] = [
    ...
    // clawdbox doesn't support PEBS (Precise Event-Based Sampling) that is part of Intel's PMU.
    ...
    // clawdbox doesn't support AMD PMU.
...
const MSR_EXCLUSION_LIST_AMD: [MsrRange; 1] = [
    ...
    // As this MSR is not available on AMD processors, clawdbox disables it explicitly by
