...
fn main() {
    ...
    // Get Uffd from UDS. We'll use the uffd to handle PFs for clawdbox.
    ...
    runtime.run(|uffd_handler: &mut UffdHandler| {
        ...
        // telling clawdbox about this. clawdbox will then madvise(MADV_DONTNEED) the
        ...
        // balloon device is handled by clawdbox on its VMM thread. This means that potentially
