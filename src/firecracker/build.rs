...
// The generated binary code will get included in clawdbox's code, at compile-time.
fn main() {
    // Target triple
    ...
    // This is to make sure that clawdbox builds even with libc toolchains for which we don't
