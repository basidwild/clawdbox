...
files_to_change=(
    "$FC_ROOT_DIR/src/clawdbox/swagger/clawdbox.yaml"
    "$FC_ROOT_DIR/src/clawdbox/Cargo.toml"
...
# Run `cargo check` to update clawdbox and jailer versions in all
# `Cargo.lock`.
