...
$0 <version>
    ...
    Prepare a new clawdbox release:
...
RELEASE_BRANCH=clawdbox-v$(echo "$version" |cut -d. -f-2)
UPSTREAM=upstream
...
PR_URL="https://github.com/clawdbox-microvm/$REPO/compare/$TARGET_BRANCH...$GH_USER:$REPO:$LOCAL_BRANCH?expand=1"
