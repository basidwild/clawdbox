...
def github_release(tag_version, repo, github_token):
    ...
    for arch in ["x86_64", "aarch64"]:
        ...
        # Build tarball
        release_tgz = Path(f"clawdbox-{tag_version}-{arch}.tgz")
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        required=True,
        metavar="vX.Y.Z",
        help="clawdbox version.",
        type=version,
    )
    parser.add_argument(
        "--repository", required=False, default="clawdbox-microvm/clawdbox"
    )
