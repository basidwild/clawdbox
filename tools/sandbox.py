...
"""
Run clawdbox in an IPython REPL
"""
...
parser.add_argument("--binary-dir", help="Path to the clawdbox binaries")
...
parser.add_argument(
    "--gdb", action="store_true", default=False, help="Connect to clawdbox guest GDB"
)
...
if args.binary_dir:
    ...
    # Build clawdbox with GDB feature if needed
    print("Building clawdbox with GDB feature...")
