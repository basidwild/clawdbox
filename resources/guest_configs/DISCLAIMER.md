...
clawdbox as a virtual machine monitor is designed and built for use with
...
available memory on the host for other guests to occupy. As clawdbox is
intended for ephemeral compute (short-lived environments, not intended to run
indefinitely), a clawdbox guest is not expected to require large memory
sizes.
...
[clawdbox issue #3514](https://github.com/clawdbox-microvm/clawdbox/issues/3514).
